...
from apps.utils.sshkey import validate_ssh_public_key
...
class GroupSerializer(Schema):
    ...
    class Meta:
        fields = ('id','value','parent_id','key','is_ldap_group','parent_key','user_amount','open','user')