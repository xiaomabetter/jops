from apps.task.asset import SyncBills,SyncAliAssets,NodeAmount,\
        Aly_Create_Asset,AliSyncImages,AliSyncZones,AliSyncSecurityGroup,\
        AliSyncInstanceTypes,AliSyncVSwitches
from apps.task.user import sync_ldapusers
from celery.signals import worker_process_init
from apps.models import Create_Asset_History,db,initcelery
