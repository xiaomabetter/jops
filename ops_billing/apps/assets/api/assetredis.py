...
from ..models import  AssetRedis,NodeRds
...
class AssetRedisViewSet(BulkModelViewSet):
    filter_fields = ("ConnectionDomain",'InstanceName')
    search_fields = filter_fields
    ordering_fields = ("ConnectionString", "ConnectionString")
    queryset = AssetRedis.objects.all()
    serializer_class = serializers.AssetRedisSerializer
