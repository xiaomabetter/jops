...
function activeNav() {
    ...
    if (app === ''){
        ...
        if (app === 'asset') {
            ...
            if ($.inArray(resource, ['ecs','slb','rds','redis']) >= 0 ) {
        ...
        if (app === 'terminal') {
            ...
            if (resource === 'terminal') {
                    $('#terminal_list').addClass('active');
            }
            if (resource === 'history') {
                    $('#session_history_list').addClass('active');
            }
            else if (resource === 'online') {
                    $('#session_online_list').addClass('active');
            }
        }
    }
}
...
jumpserver.initDataTable = function (options) {
  ...
  var table = ele.DataTable({
        ...
        language: {
            ...
            info: "第_START_至_END_项结果;共 _TOTAL_ 项",
            infoFiltered:   "",
            infoEmpty:      "",
            zeroRecords:    "没有匹配项",
            emptyTable:     "没有记录",
