    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protocol', models.CharField(choices=[('ssh', 'ssh'), ('rdp', 'rdp')], default='ssh', max_length=8)),
                ('date_last_active', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Date last active')),
