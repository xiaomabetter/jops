...
from ..custom.aly.aly import Aliyun
...
class Task(models.Model):
    ...
    task_type = models.CharField(max_length=128, choices=TYPE_CHOICES,default='ansible_cmd',verbose_name=_('Type'))
...
class AdHoc(models.Model):
    ...
    def _run_and_record(self):
        ...
        try:
            ...
            if self.task.task_type == 'ansible_cmd':
                raw, summary = self._run_only()
            elif self.task.task_type == 'custom':
                raw, summary = self
