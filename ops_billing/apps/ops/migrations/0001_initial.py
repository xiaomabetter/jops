    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('run_as', models.CharField(default='', max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_type', models.CharField(choices=[('ansible_cmd', 'ansible_cmd'), ('ansible_playbook', 'ansible_playbook'), ('script', 'script'), ('custom', 'custom')], default='ansible_cmd', max_length=128, verbose_name='Type')),
